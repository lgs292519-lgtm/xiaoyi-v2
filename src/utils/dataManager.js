...
const defaultData = {
  ...
  upcomingLives: [],
  regularSchedule: [
    // 每天三个固定时段：13-15 / 16-18 / 21-22（用于 Live 页随机掉落）
    ...
    // 21-22 为随机池（管理端可继续增删活动名）
    { id: 3, day: '每天', time: '21:00 - 22:00', activity: '小意出没，歌声相伴' },
    { id: 4, day: '每天', time: '21:00 - 22:00', activity: '小意出没，歌声相伴' },
    { id: 5, day: '每天', time: '21:00 - 22:00', activity: '小意出没，歌声相伴' },
  ],
  aboutIntro: {
    title: '关于小意OVO',
